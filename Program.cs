...
public class ShiftSchedulingSat
{
    ...
    static void Main(string[] args)
    {
        ...
        string scheduleDescription = System.IO.File.ReadAllText(sceduleDescriptionPath);
    ...
    static IEnumerable<string> SolveShiftScheduling(string scheduleDescription, bool print = false)
    {
	    ...
	    solver.StringParameters = 
            "num_search_workers:8, log_search_progress: false, max_time_in_seconds:30";
        ...
        // Print solution
        if (print && status == CpSolverStatus.Optimal || status == CpSolverStatus.Feasible)
        {
            Console.WriteLine();
            var header = "          ";
        ...
        {
            Console.WriteLine("No schedule was found with the given requirements. Try with different requirements please.");
        }
